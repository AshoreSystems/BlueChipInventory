...
import com.bluechip.inventory.adapter.CardViewInventoryReportAdapter;
import com.bluechip.inventory.adapter.CardViewJobReportAdapter;
 ...
 * {@link ViewReportFragment.OnFragmentInteractionListener} interface
...
public class ViewReportFragment extends Fragment implements View.OnClickListener {
    ...
    FloatingActionButton fab_generate_report;
    ...
    private void initializeView() {
        ...
        // float button
        fab_generate_report = (FloatingActionButton) rootView.findViewById(R.id.fab_generate_report);

        fab_generate_report.setOnClickListener(this);
        ...
        fab_generate_report.setVisibility(View.GONE);
...
*/
    ...
    public void hideShowList() {
        ...
        if (AppConstant.KEY_INVENTORY_LIST.equalsIgnoreCase("ON")) {
            ...
            fab_generate_report.setVisibility(View.VISIBLE);
