...
/*
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, int position) {
        ...
        String getArea =
                stList.get(position).getArea_name()

                + stList.get(position).getSub_area_name()

                + stList.get(position).getSec_name()

                + stList.get(position).getSub_section_name();



        viewHolder.textView_area.setText(getArea);
