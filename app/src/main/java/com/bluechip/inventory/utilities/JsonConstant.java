...
public class JsonConstant {
    ...
    //job_details
    public static String KEY_jobs_details="jobs_details";
    public static String KEY_job_id="job_id";
    public static String KEY_job_cust_id="job_cust_id";
    ...
    public static String KEY_prd_description="prd_description";
    public static String KEY_prd_sku="prd_sku";
